...
public class MyControllerTests {
	 ...
	 * 
	 * 
	 * @Test public void getMedicalRepresentativeFindByIdTestAPI() throws Exception
	 * { List<String> bkList = Arrays.asList("LOW", "MEDIUM", "HIGH");
	 * when(mjs.getAllBrackets()).thenReturn(bkList); RequestBuilder request =
	 * MockMvcRequestBuilders.get("/getAllBk").accept(MediaType.APPLICATION_JSON);
	 * mockMvc.perform(request). andExpect(status().isOk()).
	 * andExpect(content().json("[\"LOW\", \"MEDIUM\", \"HIGH\"]")) .andReturn(); }
	 */
}
